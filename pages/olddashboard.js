...
const Dashboard = () => {
    ...
    const renderFooterBar = () => (
        <div className="d-block d-md-none">
            <div className="bottom-bar card-shadow py-2">
                <div className="row m-0">
                    <div className="col-3">
                        <img src={require('../images/icons/orders.png')} style={{ maxWidth: '32px' }}/>
                    </div>
                    <div className="col-3">
                        <img src={require('../images/icons/orders.png')} style={{ maxWidth: '32px' }}/>
                    </div>
                    <div className="col-3">
                        <img src={require('../images/icons/qr-code.png')} style={{ maxWidth: '32px' }}/>
                    </div>
                    <div className="col-3">
                        <img src={require('../images/icons/orders.png')} style={{ maxWidth: '32px' }}/>
                    </div>
